...
export const TAB_INFO_CONTENTS = {
  예식장안내: [
    {
      emoji: "💍",
      text: "예식은 1부와 2부로 나누어 진행됩니다.\n대관 시간은 오후 3시까지이오니 오셔서 편안한 시간 보내시기 바랍니다.",
    },
    {
      emoji: "👰🏻‍♀️",
      text: "신부 대기실은 예식 10분 전 마감됩니다.\n본 예식장과는 별도의 건물에 위치해 있으니 참고 부탁드립니다.",
    },
    {
      emoji: "🍹",
      text: "일찍 도착하신 하객 분들께 웰컴 드링크를 제공해드립니다.",
    },
    {
      emoji: "👼🏻",
      text: "영유아를 위한 아기의자는 테라스 좌석에 준비되어 있습니다.\n아이와 함께 오셔서 축하해주세요.",
    },
    {
      emoji: "🌸",
      text: "화환은 정중히 사양합니다.\n축하해주시는 마음만으로도 큰 감사의 인사를 드립니다.",
    },
    {
      emoji: "🏧",
    ...
    {
      emoji: "💐",
      text: "예식 후 사용된 꽃 일부를 꽃다발로 나누어 드릴 예정입니다.\n수량이 한정되어 있는 점 양해 부탁드립니다.",
    },
  ],
  식사안내: [
    ...
    {
      emoji: "♾️",
      text: "코스 외에도 핀치 푸드가 함께 서빙될 예정이며,\n원하시는 만큼 리필하여 즐기실 수 있습니다.",
    },
  ],
  주차안내: [
    {
      emoji: "🚗",
      text: "예식장 내외에 주차 공간이 마련되어 있습니다.\n당일 현장 스태프의 안내에 따라 주차해주시기 바랍니다.",
    },
    {
      emoji: "⏳",
...
export const GROOM_ACCOUNTS = [
  ...
  { name: "장재연", bank: "국민", account: "835-21-0444068" },
];
